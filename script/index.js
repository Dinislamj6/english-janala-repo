...
const removeActive = () => {
    ...
    // lessonsButtons.classList.remove = "active"
    ...
    for(const word of words){
        ...
        card.innerHTML = ` 
            ...
            <div class="flex justify-between items-center">
                <button onclick="loadWordDetails(${word.id})" class="btn bg-[#1a90ff3d] hover:bg-[#1a90ffd1]"><i class="fa-solid fa-circle-info"></i></button>
                <button class="btn bg-[#1a90ff3d] hover:bg-[#1a90ffd1]"><i class="fa-solid fa-volume-high"></i></button>
            </div>
        </div>
        `
...
const displayLessons = (lessons) => {
 ...
 for(const lesson of lessons){
    ...
    btnDiv.innerHTML = ` 
       <button id="lessons-btn-${lesson.level_no}" onClick="loadLevelWord(${lesson.level_no})" class= "btn btn-outline btn-primary lesson-btn">
